		...
		if (sessionFactory == null) {
			try {
				...
				settings.put(Environment.URL,
						"jdbc:mysql://localhost:3306/ecommercewebtpjee?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC");
				...
				configuration.addAnnotatedClass(LignePanier.class);
